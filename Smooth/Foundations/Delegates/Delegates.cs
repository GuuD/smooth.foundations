...
namespace Smooth.Delegates {
    ...
    public delegate bool Predicate<in T1>(T1 obj);
    public delegate bool Predicate<in T1, in T2>(T1 obj1, T2 obj2);
    public delegate bool Predicate<in T1, in T2, in T3>(T1 obj1, T2 obj2, T3 obj3);
    public delegate bool Predicate<in T1, in T2, in T3, in T4>(T1 obj1, T2 obj2, T3 obj3, T4 obj4);
}